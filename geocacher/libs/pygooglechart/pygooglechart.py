...
class Axis(object):
    ...
    def set_style(self, colour=None, font_size=None, alignment=None):
...
class RangeAxis(Axis):
    ...
    def __init__(self, axis_index, axis_type, low, high, step=None, **kwargs):
        Axis.__init__(self, axis_index, axis_type, **kwargs)
        self.low = low
        self.high = high
        self.step = step
...
class Chart(object):
    ...
    def set_axis_range(self, axis_index,axis_type, low, high, step=None):
        assert(axis_type in Axis.TYPES)
    ...
    def set_axis_style(self, axis_index, colour=None, font_size=None, \
            alignment=None):
        try:
    ...
    def add_fill_simple(self, colour, index):
        self.markers.append(('B', colour, str(index), '0', '0'))
